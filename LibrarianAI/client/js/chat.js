...
const say_hello = async () => {
    tokens = [`Hello`, `!`, ` I`, `'m`, ` `, `OVA`, `,`, ` a `, `librarian `, `here `, `to `, `help `, `answer `, `any `, `questions `, `and `, `assist `, `you `, `with `, `information `, `about `, `the `, `book `, `'`, `48 `, `Laws `, `of `, `Power`, `'`, `. `, `Feel `, `free `, `to `, `ask `, `anything `, `related `, `to `, `the `, `content `, `of `, `the `, `book`, `, `, `and `, `I`, `'ll `, `do `, `my `, `best `, `to `, `provide `, `you `, `with `, `the `, `information `, `you`, "`re ", `looking `, `for`, `.`]
...
const ask_gpt = async (message) => {
  try {
    ...
    if (e.name != `AbortError`) {
      let error_message = `Incorrect API key provided. You can find your API key at https://platform.openai.com/account/api-keys.`;
